...
function SimpleShader(vertexShaderPath, fragmentShaderPath) {
    ...
    this.mOffset = null;                        // reference to the offset uniform in the vertex shader
    this.mScale = null;                         // reference to the scale uniform in the vertex shader
    ...
    // Get references to the uniform variable uPixelColor, uOffset, uScale
...
SimpleShader.prototype.activateShader = function (offset,scale,pixelColor) {
    var gl = gEngine.Core.getGL();
    ...
    // Set the offset, scale, pixelColor to the inputted values
